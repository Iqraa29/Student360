...
from cms_app import views, HodViews, StaffViews, StudentViews
from cms_app.EditResultVIewClass import EditResultViewClass
from cms_system import settings
#-----------------------------------------------------------------------------
urlpatterns = [
                    #ALL THE PATH OF ADMIN PAGE
...
]+static(settings.MEDIA_URL,document_root=settings.MEDIA_ROOT)+static(settings.STATIC_URL,document_root=settings.STATIC_ROOT)#TO LINK THE MEDIA AND STATIC PATHS INTO THE URLS.PY ALSO
